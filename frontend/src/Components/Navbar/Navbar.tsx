...
import ProcurifyInterviewPrep from "../../interviewPrepTasks/ReactQuestions/SinglePageApps/ProcurifyInterviewPrep/frontend/App";

const PAGES: Record<string, React.ReactNode> = {
  ProcurifyInterviewPrep: <ProcurifyInterviewPrep />,
